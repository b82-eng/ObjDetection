...
while(True):
    ...
    grayLeft = cv2.cvtColor(frame, cv2.COLOR_RGB2GRAY)
    grayRight = cv2.cvtColor(frame2, cv2.COLOR_RGB2GRAY)
    ...
    #stereo = cv2.StereoBM_create(numDisparities=15, blockSize=15)
